    ...
    <footer className='max-container'>
      <div className='flex  justify-between items-center gap-20 flex-wrap max-lg:flex-col'>
          <div className='flex flex-1 flex-col items-start'>
              ...
              <p className='mt-6 text-base font-montserrat text-white-400 leading-7sm:max-w-sm'>Get Shoes ready for the new term at your nearest Nike store. Find your perfect size in Store. Get Rewards</p>
